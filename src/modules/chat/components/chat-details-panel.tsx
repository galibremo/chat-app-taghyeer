...
import { NormalizedConversation } from "@/types/chat";
...
export function ChatDetailsPanel({
  ...
  return (
    <div className="w-full md:w-80 lg:w-96 flex flex-col h-full bg-zinc-950 border-l border-zinc-800/80 animate-in slide-in-from-right duration-200">
      {/* Header */}
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                {isAdmin && (
                  <button
                    ...
                    title="Rename group"
                    className="text-zinc-500 hover:text-indigo-400 text-xs"
                  >
                    ✏️
                  </button>
                )}
                      ...
                      {isAdmin && !isSelf && (
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="text-[10px] px-2 py-1 rounded bg-rose-950/60 hover:bg-rose-900 text-rose-300 border border-rose-800/40"
                          >
                            Remove
                          </button>
                        </div>
        ...
        {isGroup && (
          <div className="pt-4 border-t border-zinc-800">
            <button
              ...
              disabled={removeParticipantMutation.isPending}
              className="w-full py-2.5 rounded-xl bg-rose-950/40 hover:bg-rose-950/80 text-rose-400 border border-rose-900/60 text-xs font-semibold transition-colors"
            >
              Leave Group
            </button>
          </div>
